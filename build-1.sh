...
echo "DEPLOY_SUFFIX: ${DEPLOY_SUFFIX} BRANCH ${BRANCH} SRC_DIR ${SRC_DIR} BUILD_DIR ${BUILD_DIR} REPO_SLUG ${REPO_SLUG}."
echo "COMMIT_SHA ${COMMIT_SHA} DEPLOY_BRANCH ${DEPLOY_BRANCH} COMMIT_AUTHOR_NAME ${COMMIT_AUTHOR_NAME} COMMIT_AUTHOR_EMAIL ${COMMIT_AUTHOR_EMAIL}"
echo "COMMIT_COMMITTER_NAME ${COMMIT_COMMITTER_NAME}"
echo "COMMIT_COMMITTER_EMAIL ${COMMIT_COMMITTER_EMAIL}"
# Run some checks
# ---------------
